...
?> 	 
		<div class="col-md-9">
			...
			<div class="col-md-12">
				<hr>
				<h4><strong>NOTA PEMBELIAN</strong></h4>
				<h5>Detail Pesanan yang Anda beli:</h5>				
		...
		<thead> 
			...
			<tbody> 
		 <?php
			$pes = mysqli_fetch_array($koneksi->query("SELECT*FROM pesanan WHERE user_id='$_SESSION[iam_user]' ORDER BY id DESC limit 1"));
			$q = $koneksi->query("SELECT * FROM detail_pesanan WHERE pesanan_id='$pes[id]'");
			$ongkir = $pes['ongkir'];
			$total = 0;
